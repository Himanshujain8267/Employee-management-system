...
const AllTask = () => {
  ...
  return (
    <div className="bg-linear-to-br from-indigo-400 to-slate-900 p-8 rounded-xl mt-8 shadow-lg min-h-80">
        ...
        <table className="min-w-full text-sm text-left text-gray-200">
          ...
          <tbody className="bg-slate-800 divide-y divide-slate-700">
            {authData.employees.map((employee, idx) => (
              <tr key={idx} className="hover:bg-indigo-200 transition">
                <td className="flex items-center gap-3 px-4 py-2">
                  <div className="w-9 h-9 rounded-full bg-indigo-150 flex items-center justify-center text-white font-bold shadow-md">
